...
# from setuptools import setup ( name='flaskr', packages=['flaskr'], include_package_data=True, install_requires=[ 'flask', ], )
...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format('postgres', 'Blessingeyeghele1996@', 'localhost:5432', self.database_name)
        # self.database_path = 'postgres://postgres/Blessingeyeghele1996@'.format('localhost:5432',  self.database_name)
